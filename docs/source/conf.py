...
# -*- coding: utf-8 -*-
#
# ipywidgethello documentation build configuration file
#
...
project = 'ipywidgethello'
copyright = '2017, Vidar Tonaas Fauske'
...
_version_py = os.path.join(repo, 'ipywidgethello', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipywidgethellodoc'
...
latex_documents = [
    (master_doc, 'ipywidgethello.tex', 'ipywidgethello Documentation',
